			...
			<table class="table table-borderless" id="table">
				...
				<tr class="item{{$item->id}}">
					...
					<td><button class="edit-modal btn btn-info"
							data-info="{{$item->name}},{{$item->meeting_time}},{{$item->day}},{{$item->floor}}">
				...
				<div class="modal-body">
					<form class="form-horizontal" role="form">
						<div class="form-group">
							<label class="control-label col-sm-2" for="id">團契名稱：</label>
							<div class="col-sm-10">
								<input type="text" class="form-control" id="fid" disabled>
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-sm-2" for="fname">聚會時間：</label>
							<div class="col-sm-10">
						...
						<div class="form-group">
							<label class="control-label col-sm-2" for="lname">禮拜幾:</label>
							<div class="col-sm-10">
						...
						<div class="form-group">
							<label class="control-label col-sm-2" for="email">樓層</label>
							<div class="col-sm-10">
