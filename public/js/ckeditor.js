...
(function() {
        ...
        var a = /(^|.*[\\\/])ckeditor\.js(?:\?.*|;.*)?$/i,
            d = {
                ...
                domReady: function() {
                    ...
                    return function(b) {
                        function n() {
                            try { document.documentElement.doScroll("left") } catch (f) { setTimeout(n, 1);
                                return }
                            a() }
                        c.push(b);
    ...
    CKEDITOR.event || (CKEDITOR.event = function() {}, CKEDITOR.event.implementOn = function(a) {
        ...
        return {
            ...
            on: function(b, d, g, h, k) {
                function n(a, f, D, k) { a = { name: b, sender: this, editor: a, data: f, listenerData: h, stop: D, cancel: k, removeListener: u };
                    return !1 === d.call(g, a) ? !1 : a.data }

                function u() { D.removeListener(b, d) }
                var f = a.call(this, b);
                if (0 > f.getListenerIndex(d)) { f = f.listeners;
                    ...
                    for (var w = f.length - 1; 0 <= w; w--)
                        if (f[w].priority <= k) return f.splice(w + 1, 0, n), { removeListener: u };
                    f.unshift(n) }
                    ...
                    if (f) {
                        ...
                        if (w.length)
                            for (var w = w.slice(0), A, F = 0; F < w.length; F++) {
                                ...
                                } catch (x) {} else A = w[F].call(this, u, n, b, h);
    ...
    (function() {
        ...
        CKEDITOR.tools = {
            ...
            normalizeHex: function(a) {
                return a.replace(/#(([0-9a-f]{3}){1,2})($|;|\s+)/gi, function(a, b, c, k) { a = b.toLowerCase();
    ...
    CKEDITOR.dom.nodeList.prototype = { count: function() {
            ...
            return 0 > a || a >= this.$.length ? null : (a = this.$[a]) ? new CKEDITOR.dom.node(a) : null }, toArray: function() {
    ...
    (function() {
        ...
        CKEDITOR.dom.walker.ignored =
            function(a) {
                return function(b) { b = g(b) || h(b) || k(b);
                    return !!(a ^ b) } };
    ...
    (function() {
        ...
        function d(a, b, c, d, e) {
            ...
            var t = a.startContainer,
                ...
                E = a.endOffset,
                q, y, v, B, L, n;
            if (l && J.type == CKEDITOR.NODE_TEXT && (t.equals(J) || t.type === CKEDITOR.NODE_ELEMENT && t.getFirst().equals(J))) c.append(a.document.createText(J.substring(H, E)));
            else {
                ...
                for (var O = t.getParents(), p = J.getParents(), C = m(),
                        r = O.length - 1, G = p.length - 1, N = c, P, Y, V, ea = -1, Q = C; Q <= r; Q++) { Y = O[Q];
                    V = Y.getNext();
                    for (Q != r || Y.equals(p[Q]) && r < G ? b && (P = N.append(Y.clone(0, e))) : q ? g(Y, N, !1, v) : L && N.append(a.document.createText(Y.substring(H))); V;) {
                        if (V.equals(p[Q])) { ea = Q;
                            break }
                        V = g(V, N) }
                    N = P }
                N = c;
                for (Q = C; Q <= G; Q++)
                    if (c = p[Q], V = c.getPrevious(), c.equals(O[Q])) b && (N = N.getChild(0));
                    else { Q != G || c.equals(O[Q]) && G < r ? b && (P = N.append(c.clone(0, e))) : y ? g(c, N, !1, B) : n && N.append(a.document.createText(c.substring(0, E)));
                        if (Q > ea)
                            for (; V;) V = g(V, N, !0);
                        N = P }
                l || k()
        ...
        function e(a) {
            return function() {
                var b;
                return this[a ? "getPreviousNode" : "getNextNode"](function(a) {!b && u(a) && (b = a);
                ...
                switch (a) {
                    ...
                    case CKEDITOR.ENLARGE_ELEMENT:
                        ...
                        E.type == CKEDITOR.NODE_TEXT ? (y && (E = !CKEDITOR.tools.trim(E.substring(0, y)).length && E, H = !!E), E && ((t = E.getPrevious()) || (l = E.getParent()))) : (y && (t = E.getChild(y - 1) || E.getLast()),
                            t || (l = E));
                        for (l = c(l); l || t;) {
                            if (l && !t) {!J && l.equals(m) && (J = !0);
                                if (e ? l.isBlockBoundary() : !k.contains(l)) break;
                                H && "inline" == l.getComputedStyle("display") || (H = !1, J ? h = l : this.setStartBefore(l));
                                t = l.getPrevious() }
                            for (; t;)
                                if (E = !1, t.type == CKEDITOR.NODE_COMMENT) t = t.getPrevious();
                                else {
                                    if (t.type == CKEDITOR.NODE_TEXT) q = t.getText(), d.test(q) && (t = null), E = /[\s\ufeff]$/.test(q);
                                        ...
                                        if (H && CKEDITOR.dtd.$removeEmpty[t.getName()]) {
                                            ...
                                            if (d.test(q)) t = null;
                                                ...
                                                for (var y = t.$.getElementsByTagName("*"), v = 0, B; B = y[v++];)
                                                    if (!CKEDITOR.dtd.$removeEmpty[B.nodeName.toLowerCase()]) { t = null;
                                                        break }
                                            t && (E = !!q.length)
                                        } else t = null;
                                    E && (H ? J ? h = l : l && this.setStartBefore(l) : H = !0);
                                    if (t) { E = t.getPrevious();
                                        if (!l && !E) { l = t;
                                            t = null;
                                            break }
                                        t = E } else l = null
                        ...
                        for (; l || t;) {
                            ...
                            for (; t;) {
                                E = !1;
                                if (t.type == CKEDITOR.NODE_TEXT) q = t.getText(), g(t, 0) || (t = null), E = /^[\s\ufeff]/.test(q);
                                    ...
                                    if ((0 < t.$.offsetWidth || b && t.is("br")) && !t.data("cke-bookmark"))
                                        if (H && CKEDITOR.dtd.$removeEmpty[t.getName()]) {
                                            ...
                                            if (d.test(q)) t = null;
                                                ...
                                                for (y = t.$.getElementsByTagName("*"), v = 0; B = y[v++];)
                                                    if (!CKEDITOR.dtd.$removeEmpty[B.nodeName.toLowerCase()]) { t = null;
                                                        break }
                                            t && (E = !!q.length)
                                        } else t = null
                ...
                for (this._.nextNode = null; m;) {
                    ...
                    if (I) m.type == CKEDITOR.NODE_TEXT && e.test(m.getText()) && (I = 0);
                        ...
                        if (CKEDITOR.dtd.$block[t] && "false" == m.getAttribute("contenteditable")) { d = m;
                            b(this, a, d);
                            break } else if (m.isBlockBoundary(this.forceBrBreak && !z && { br: 1 })) {
                            if ("br" == t) I = 1;
                            else if (!h && !m.getChildCount() && "hr" != t) { d = m;
                                w = m.equals(x);
                                break }
                            h && (h.setEndAt(m, CKEDITOR.POSITION_BEFORE_START), "br" != t && (this._.nextNode = m));
                            K = 1 } else {
                            if (m.getFirst()) { h || (h = this.range.clone(), h.setStartAt(m, CKEDITOR.POSITION_BEFORE_START));
                                m = m.getFirst();
                                continue }
                            I = 1 }
                    }
                    ...
                    w = (!K || I) && m.equals(x);
                    if (h && !K)
                        for (; !m.getNext(k) && !w;) { t = m.getParent();
                            if (t.isBlockBoundary(this.forceBrBreak && !z && { br: 1 })) { K = 1;
                                I = 0;
                                w || t.equals(x);
    ...
    (function() {
            ...
            if (e = a.requiredClasses)
                for (l = b.classes, c = 0; c < e.length; ++c)
                    if (d = e[c], "string" == typeof d) {
                        if (-1 == CKEDITOR.tools.indexOf(l, d)) return !1 } else if (!CKEDITOR.tools.checkIfAnyArrayItemMatches(l, d)) return !1;
        ...
        function f(a) {
            var b, c, d, e, l = {},
                r = 1;
            for (a = B(a); b = a.match(p);)(c = b[2]) ? (d = D(c, "styles"), e = D(c, "attrs"), c = D(c, "classes")) : d = e = c = null, l["$" + r++] = { elements: b[1], classes: c, styles: d, attributes: e }, a = a.slice(b[0].length);
            return l }
        ...
        function A(a, b, e, l) {
            ...
            if (l.doCallbacks && a.elementCallbacks) { a: { q = a.elementCallbacks;
                    for (var v = 0, g = q.length, p; v < g; ++v)
                        if (p = q[v](b)) { q = p;
                            break a }
                    q = void 0 }
                if (q) return q }
            if (l.doTransform && (q = a._.transformations[b.name])) { w(b);
            ...
            if (l.doFilter) {
                a: {
                    ...
                    if (a || q) { w(b);
                        ...
                        if (q)
                            for (B = 0, C = q.length; B < C; ++B) d(q[B], b, y, p);
                        a = y } else a = null
                }
                ...
                if (!a.allClasses ||
                    ...
                    p && y.length < p.split(/\s+/).length && (B = !0) } else p && (v["class"] = p);B && (f = 1);
        ...
        function t(a, b, c) {
            ...
            for (d = 0; d < c.length; ++d)
                if (e = c[d], !(e.check && !a.check(e.check, !1) || e.left && !e.left(b))) { e.right(b, N);
                    break } }
        ...
        function J(a, b) {
            ...
            for (l in d)
                if ("class" == l)
                    for (c = d[l].split(/\s+/), r = a.classes.join("|"); v = c.pop();) {
                        if (-1 == r.indexOf(v)) return !1 } else if (a.attributes[l] != d[l]) return !1;
            for (f in e)
                if (a.styles[f] !=
                    e[f]) return !1;
            return !0
        ...
        CKEDITOR.filter.prototype = {
            ...
            applyTo: function(a, b, c, d) {
                ...
                for (; p = a.pop();)
                    if (c = p.el, c.parent) switch (t = y[c.parent.name] || y.span, p.check) {
                        case "it":
                ...
                if (!this.disabled && a) {
                    ...
                    for (e = 0; e < a.length; ++e) {
                        ...
                        for (f = 0; f < b.length; ++f) r = b[f], "string" == typeof r ? (r = r.split(/\s*:\s*/), v = r[0], g = null, p = r[1]) : (v = r.check, g = r.left, p = r.right), l || (l = r, l = l.element ? l.element : v ? v.match(/^([a-z0-9]+)/i)[0] :
                            l.left.getDefinition().element), g instanceof CKEDITOR.style && (g = E(g)), c.push({ check: v == l ? null : v, left: g, right: "string" == typeof p ? q(p) : p });
                        b = l;
                        d[b] || (d[b] = []);
                        d[b].push(c)
                    }
            ...
            check: function(a, b, c) {
                ...
                if ("string" == typeof a) {
                    ...
                    e = d
                } else d = a.getDefinition(), e = d.styles, r = d.attributes || {}, e && !CKEDITOR.tools.isEmpty(e) ? (e = v(e), r.style = CKEDITOR.tools.writeCssText(e, !0)) : e = {}, e = { name: d.element, attributes: r, classes: r["class"] ? r["class"].split(/\s+/) : [], styles: e, children: [] };
                            ...
                            if (a[b]) D(b, !0);
                                ...
                                if (!(1 < e.length)) {
                                    ...
                                    c && (CKEDITOR.env.ie && (8 >= CKEDITOR.env.version || CKEDITOR.env.ie9Compat) ? f.$.onreadystatechange = function() {
                                        if ("loaded" == f.$.readyState || "complete" == f.$.readyState) f.$.onreadystatechange = null, w(b, !0) } : (f.$.onload = function() { setTimeout(function() { w(b, !0) }, 0) }, f.$.onerror = function() { w(b, !1) }));
                ...
                h = function(b) {
                    a.call(this, b, function(a) {
                        ...
                        for (f in a) {
                            ...
                            if (!d[f]) {
                                if (k.icons)
                                    for (var A = k.icons.split(","), F = A.length; F--;) CKEDITOR.skin.addIcon(A[F], k.path + "icons/" + (CKEDITOR.env.hidpi && k.hidpi ? "hidpi/" : "") + A[F] + ".png");
                                d[f] = 1 }
                            if (w)
    ...
    (function() {
        ...
        function d() { do var a = "editor" + ++F; while (CKEDITOR.instances[a]);
            return a }
        ...
        function n(a) { CKEDITOR.skin.loadPart("editor", function() { u(a) }) }
        ...
        CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
            ...
            getSnapshot: function() {
                var a = this.fire("getSnapshot"); "string" != typeof a && (a = (a = this.element) && this.elementMode == CKEDITOR.ELEMENT_MODE_REPLACE ? a.is("textarea") ? a.getValue() : a.getHtml() : "");
                return a },
                ...
                F.onTagOpen = function(e, f, g, k) {
                    ...
                    if (a(f)) m.push(f);
                        ...
                        if ("pre" == e) l = !0;
                            ...
                            if ("br" == e && l) { z.add(new CKEDITOR.htmlParser.text("\n"));
        ...
        a.prototype = {
            ...
            exec: function(a, c) {
                var d = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment,
                    ...
                    n, u, f, D;
                for (D = 0; D < k; D++)
                    if (d && (n = c.type, u = c.name), f = h[D], !(a.nonEditable && !f.options.applyToAll ||
    ...
    (function() {
                ...
                return function(e) {
                    if (e.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        var l = [],
                            ...
                            v, p;
                        if (r)
                            for (q(r, 1) && l.push(r); r;) g(r) && (v = c(r)) && q(v) && ((p = c(v)) && !g(p) ? l.push(v) : (f(y).insertAfter(v), v.remove())), r = r.previous;
            ...
            return a.replace(q,
                function(a, b, c) {
                    return "\x3c" + b + c.replace(y, function(a, b) {
                        return v.test(b) && -1 == c.indexOf("data-cke-saved-" + b) ? " data-cke-saved-" + a + " data-cke-" + CKEDITOR.rnd + "-" + a : a }) + "\x3e" })
        }
        ...
        function x(a, b) {
            ...
            for (var l = 0; l < d.length; l++) a = a.replace(d[l], function(a) { a = a.replace(f, function(a, b, d) {
                    return c[d] });
            ...
            a = a.replace(/<\w+(?:\s+(?:(?:[^\s=>]+\s*=\s*(?:[^'"\s>]+|'[^']*'|"[^"]*"))|[^\s=\/>]+))+\s*\/?>/g, function(a) {
                return a.replace(/\x3c!--\{cke_protected\}([^>]*)--\x3e/g, function(a, b) { e[e.id] = decodeURIComponent(b);
        ...
        CKEDITOR.editor.prototype.setMode = function(a, b) {
            ...
            if (a != d.mode && h && h[a]) {
                ...
                if (d.mode) {
                    ...
                    d._.previousModeData = n = d.getData(1); "source" == d.mode && h == n && (d.fire("lockSnapshot", { forceUpdate: !0 }), u = 1);
                ...
                fixInitialSelection: function() {
                    function a() {
                        ...
                        a: if (d.anchorNode && d.anchorNode == c.$) e = !0;
                                ...
                                if (CKEDITOR.env.webkit && (e = c.getDocument().getActive()) && e.equals(c) && !d.anchorNode) { e = !0;
                                    break a }
                                e = void 0 }
        ...
        x = function() {
            ...
            return function(B, p, C, r) {
                ...
                if (!r.checkReadOnly()) {
                    ...
                    B = { type: p, dontFilter: N, editable: B, editor: G, range: r, blockLimit: P, mergeCandidates: [], zombies: [] };
                    p = B.range;
                    r = B.mergeCandidates;
                    var m, w;
                    ...
                    if (m = C) {
                        ...
                        if ((D = m.startPath().block) && (1 != D.getChildCount() || !D.getBogus())) a: {
                            var A;
                            if (1 ==
                                w.getChildCount() && a(A = w.getFirst()) && A.is(n) && !A.hasAttribute("contenteditable")) { D = A.getElementsByTag("*");
                                m = 0;
                                for (r = D.count(); m < r; m++)
                    ...
                    if (m) {
                        ...
                        for (g(p, A); r < p.length; r++) {
                            P = p[r];
                            if (M = P.isLineBreak) { M = A;
                                I = w;
                                var S = void 0,
                                    Z = void 0;
                                P.hasBlockSibling ? M = 1 : (S = M.startContainer.getAscendant(v.$block, 1)) && S.is({ div: 1, p: 1 }) ? (Z = S.getPosition(I), Z == CKEDITOR.POSITION_IDENTICAL || Z == CKEDITOR.POSITION_CONTAINS ? M = 0 : (I = M.splitElement(S), M.moveToPosition(I, CKEDITOR.POSITION_AFTER_START), M = 1)) : M = 0 }
                            if (M) C = 0 < r;
                            else {
                                M = A.startPath();
                    ...
                    if (K)
                        for (; F = K.pop();) CKEDITOR.env.needsBrFiller ? F.appendBogus() : F.append(z.document.createText(" "));
                    ...
                    if (!B.dontMoveCaret) {
                        for (F = e(z); F && a(F) && !F.is(v.$empty);) {
                            if (F.isBlockBoundary()) z.moveToPosition(F, CKEDITOR.POSITION_BEFORE_END);
                                ...
                                if (f(F) && F.getHtml().match(/(\s|&nbsp;)$/g)) { R = null;
                                    break }
                                R = z.clone();
            ...
            tree: {
                rebuild: function(a, b) {
                    ...
                    if (e.blockLimit.is({
                        ...
                        g = function(a) {
                            return !a.equals(v) } } else if (e.block && e.block.is(CKEDITOR.dtd.$listItem) && (f = f.contains(CKEDITOR.dtd.$list), c = c.contains(CKEDITOR.dtd.$list), !f.equals(c))) {
    ...
    (function() {
        ...
        var x = "function" != typeof window.getSelection,
            ...
            z = new RegExp(K + "( )?", "g"),
            I, l, t, J = CKEDITOR.dom.walker.invisible(1),
            H = function() {
                function a(b) {
                    return function(a) {
        ...
        CKEDITOR.on("instanceCreated", function(a) {
            ...
            c.on("contentDom", function() {
                function a() { n = new CKEDITOR.dom.selection(c.getSelection());
                    n.lock() }
                ...
                function d(a) {
                    if (CKEDITOR.env.ie) {
                        var b = (a = a.getRanges()[0]) ? a.startContainer.getAscendant(function(a) {
                            return a.type == CKEDITOR.NODE_ELEMENT && ("false" == a.getAttribute("contenteditable") || "true" == a.getAttribute("contenteditable")) }, !0) : null;
                ...
                if (CKEDITOR.env.ie || q) x ? h.attachListener(h, "beforedeactivate", a, null, null, -1) : h.attachListener(c, "selectionCheck", a, null, null, -1), h.attachListener(h, CKEDITOR.env.webkit ? "DOMFocusOut" : "blur", function() { c.lockSelection(n);
                ...
                if (CKEDITOR.env.ie && !q) {
                    ...
                    h.attachListener(h, "mouseup", function(a) { 2 == a.data.$.button && m && (c.document.$.documentElement.scrollLeft = m.x, c.document.$.documentElement.scrollTop = m.y);
                        m = null });
                        ...
                        if (CKEDITOR.env.ie7Compat || CKEDITOR.env.ie6Compat) {
                            ...
                            l.on("mousedown", function(a) {
                                ...
                                function c() { l.removeListener("mousemove", b);
                                    ...
                                    u.select() }
                                a = a.data;
                                if (a.getTarget().is("html") && a.$.y < l.$.clientHeight && a.$.x < l.$.clientWidth) { u = r.$.createTextRange();
                                    try { u.moveToPoint(a.$.clientX, a.$.clientY) } catch (d) {}
                                    w = u.duplicate();
                                    l.on("mousemove", b);
                                    p.on("mouseup", c);
                                    l.on("mouseup", c) }
                ...
                if (q && (CKEDITOR.env.webkit || CKEDITOR.env.gecko)) {
                    var t;
                    h.attachListener(h, "mousedown", function() { t = 1 });
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.selection, { _removeFillingCharSequenceString: D, _createFillingCharSequenceNode: u, FILLING_CHAR_SEQUENCE: K });
                ...
                var a = x ? function() {
                    ...
                    var b = function(b, c) {
                        ...
                        for (var e = d.children, f, g, h = b.duplicate(), k = 0,
                                l = e.length - 1, q = -1, n, m; k <= l;)
                            if (q = Math.floor((k + l) / 2), f = e[q], h.moveToElementText(f), n = h.compareEndPoints("StartToStart", b), 0 < n) l = q - 1;
                            else if (0 > n) k = q + 1;
                        ...
                        for (; 0 < h;) try { g = f[0 < n ? "previousSibling" : "nextSibling"], g.nodeType == CKEDITOR.NODE_TEXT && (h -= g.nodeValue.length, m = g), f = g } catch (u) {
                        ...
                        if (l) this.fake(l);
                            ...
                            if (x) {
                                ...
                                for (m = 0; m < b.length; m++) {
                                    if (m <
                                        b.length - 1 && (r = b[m], G = b[m + 1], l = r.clone(), l.setStart(r.endContainer, r.endOffset), l.setEnd(G.startContainer, G.startOffset), !l.collapsed && (l.shrink(CKEDITOR.NODE_ELEMENT, !0), d = l.getCommonAncestor(), l = l.getEnclosedNode(), d.isReadOnly() || l && l.isReadOnly()))) { G.setStart(r.startContainer, r.startOffset);
                                        b.splice(m--, 1);
                                        continue }
                                    d = b[m];
                                    ...
                                    try { G.setEnd(d.endContainer.$, d.endOffset) } catch (t) {
                                        if (0 <= t.toString().indexOf("NS_ERROR_ILLEGAL_VALUE")) d.collapse(1), G.setEnd(d.endContainer.$, d.endOffset);
                                        else throw t; }
                                    k.addRange(G)
                                }
                            }
    ...
    (function() {
            ...
            if (c.collapsed) f = K(this, f), c.insertNode(f), c.moveToPosition(f, CKEDITOR.POSITION_BEFORE_END);
                ...
                for (q.getPosition(t) == CKEDITOR.POSITION_FOLLOWING && (q = 0); q;) {
                    ...
                    if (q.equals(t)) q = null, l = !0;
                        ...
                        if (A && q.data("cke-bookmark")) { q = q.getNextSourceNode(!0);
                            continue }
                        if (x && m && CKEDITOR.dtd.$block[A])
                            for (var z = q, y = e(z), E = void 0, H = y.length, I = 0, z = H && new CKEDITOR.dom.range(z.getDocument()); I < H; ++I) {
                                var E = y[I],
                        ...
                        if (y)
                            if (E = q.getParent(), y = h, H = g, I = k, !E || !(E.getDtd() || CKEDITOR.dtd.span)[H] && !I || y.parentRule && !y.parentRule(E)) l = !0;
                            else {
                                if (v ||
                                    ...
                                    for (var A = q, L;
                                        (l = !A.getNext(B)) && (L = A.getParent(), n[L.getName()]) && d(L, w, h, O);) A = L;
                                    v.setEndAfter(A) }
                            }
                        else l = !0;
        ...
        CKEDITOR.style.prototype = {
            ...
            applyToRange: function(a) { this.applyToRange = this.type == CKEDITOR.STYLE_INLINE ? b : this.type == CKEDITOR.STYLE_BLOCK ? k : this.type == CKEDITOR.STYLE_OBJECT ? g : null;
        ...
        CKEDITOR.style.getStyleText = function(a) {
            ...
            for (var e in b) {
                var f = b[e],
                    g = (e + ":" + f).replace(y, ";"); "inherit" == f ? d += g : c += g }
            ...
            do
                if (n.type == CKEDITOR.NODE_ELEMENT) {
                    ...
                    if (!h && (u = n.getName(),
                        ...
                        if (u = !g && "div" == u) { a: { u = n.getChildren();
                                for (var f = 0, D = u.count(); f < D; f++) {
                                    var w = u.getItem(f);
                                    if (w.type == CKEDITOR.NODE_ELEMENT && CKEDITOR.dtd.$block[w.getName()]) { u = !0;
                                        break a } }
                                u = !1 }
                            u = !u }
                        u ? g = n : h = n }
    ...
    CKEDITOR.dom.elementPath.prototype = {
        ...
        contains: function(a, d, b) {
            ...
            a instanceof CKEDITOR.dom.element ? e = function(b) {
                return b.equals(a) } : CKEDITOR.tools.isArray(a) ? e = function(b) {
                return -1 < CKEDITOR.tools.indexOf(a, b.getName()) } : "function" == typeof a ? e = a : "object" == typeof a && (e = function(b) {
                return b.getName() in
                    a
            });
            var g = this.elements,
    ...
    */
        ...
        function D(a) {
            function d() {
                for (var b = f(), e = CKEDITOR.tools.clone(a.config.toolbarGroups) || v(a), n = 0; n < e.length; n++) {
                    var g = e[n];
                    if ("/" != g) { "string" == typeof g && (g = e[n] = { name: g });
                        var l, d = g.groups;
                        if (d)
        ...
        CKEDITOR.ui.prototype.addToolbarGroup = function(a, d, f) {
            ...
            if (f) {
                if (f = CKEDITOR.tools.search(c, function(a) {
                    ...
                    !f.groups && (f.groups = []);
                    if (d &&
                        (d = CKEDITOR.tools.indexOf(f.groups, d), 0 <= d)) { f.groups.splice(d + 1, 0, a);
                        return }
    ...
    (function() {
        ...
        function A(b, a) {
            ...
            CKEDITOR.env.webkit && -1 < a.indexOf("\x3cdiv\x3e") && (a = a.replace(/^(<div>(<br>|)<\/div>)(?!$|(<div>(<br>|)<\/div>))/g, "\x3cbr\x3e").replace(/^(<div>(<br>|)<\/div>){2}(?!$)/g, "\x3cdiv\x3e\x3c/div\x3e"),
                a.match(/<div>(<br>|)<\/div>/) && (a = "\x3cp\x3e" + a.replace(/(<div>(<br>|)<\/div>)+/g, function(b) {
                    return c(b.split("\x3c/div\x3e\x3cdiv\x3e").length + 1) }) + "\x3c/p\x3e"), a = a.replace(/<\/div><div>/g, "\x3cbr\x3e"), a = a.replace(/<\/?div>/g, ""));
        ...
        function B(b, a) { b.enterMode == CKEDITOR.ENTER_BR ? a = a.replace(/(<\/p><p>)+/g, function(b) {
                return CKEDITOR.tools.repeat("\x3cbr\x3e", b.length / 7 * 2) }).replace(/<\/?p>/g, "") : b.enterMode == CKEDITOR.ENTER_DIV && (a = a.replace(/<(\/)?p>/g, "\x3c$1div\x3e"));
            return a }
        ...
        function E(b) {
            ...
            b.on("contentDom", function() {
                ...
                function g(b) { b.type != CKEDITOR.NODE_ELEMENT && (b = b.getParent());
                ...
                e.attachListener(h, "drop", function(c) {
                    if (!c.data.$.defaultPrevented) { c.data.preventDefault();
            ...
            init: function(b) {
                ...
                b.on("paste", function(b) {
                        var a = b.data.dataValue,
                            ...
                            return b.replace(/\t/g, "\x26nbsp;\x26nbsp; \x26nbsp;") })), -1 < a.indexOf('\x3cbr class\x3d"Apple-interchange-newline"\x3e') && (b.data.startsWithEOL = 1, b.data.preSniffing = "html", a = a.replace(/<br class="Apple-interchange-newline">/, "")), a = a.replace(/(<[^>]+) class="Apple-[^"]*"/gi, "$1"));
                        ...
                        CKEDITOR.env.ie ? a = a.replace(/^&nbsp;(?: |\r\n)?<(\w+)/g, function(a, e) {
                            return e.toLowerCase() in c ? (b.data.preSniffing = "html", "\x3c" + e) : a }) : CKEDITOR.env.webkit ? a = a.replace(/<\/(\w+)><div><br><\/div>$/, function(a, e) {
                            return e in c ? (b.data.endsWithEOL = 1, "\x3c/" + e + "\x3e") : a }) : CKEDITOR.env.gecko && (a = a.replace(/(\s)<br>$/, "$1"));
                        b.data.dataValue = a
                    }, null,
                    null, 3);
                b.on("paste", function(a) {
                ...
                _: {
                    ...
                    markFirstDisplayed: function(a) {
                        for (var b = function(a) {
                                return a.type == CKEDITOR.NODE_ELEMENT && "none" == a.getStyle("display") }, e = this._.getItems(), d, c, f = e.count() - 1; 0 <= f; f--)
    ...
    (function() {
        function v(a, b, c, m, h) { h = CKEDITOR.tools.genKey(b.getUniqueId(), c.getUniqueId(), a.lang.dir, a.uiColor || "", m.css || "", h || "");
            var g = f[h];
    ...
    (function() {
        function q(b, d, a) { a = b.config.forceEnterMode || a;
            if ("wysiwyg" == b.mode) { d || (d = b.activeEnterMode);
                var h = b.elementPath();
                ...
                render: function(a, b) {
                    ...
                    var c =
                        ...
                        e = CKEDITOR.tools.addFunction(function(b) { l && (a.unlockSelection(1), l = 0);
                            g.execute(b) }, this),
                        d = this,
                        g = { id: h, combo: this, focus: function() { CKEDITOR.document.getById(h).getChild(1).focus() }, execute: function(b) {
                                var c = d._;
                    ...
                    var m = CKEDITOR.tools.addFunction(function(a, b) { a = new CKEDITOR.dom.event(a);
                ...
                function f(d) {
                    ...
                    d.on("key",
                        function(f) {
                            ...
                            if ("wysiwyg" == d.mode && f.data.keyCode == this.indentKey && c) {
                                var n = this.getContext(c);!n || this.isIndent && CKEDITOR.plugins.indentList.firstItemInPath(this.context, c, n) || (d.execCommand(this.relatedGlobal), f.cancel()) } }, this);
                    this.jobs[this.isIndent ? 10 : 30] = {
                        refresh: this.isIndent ? function(d, c) {
                            ...
                            return f && this.isIndent && !b ? v : u } : function(d, c) {
        ...
        CKEDITOR.plugins.link = {
            ...
            parseLinkAttributes: function(c, b) {
                var a = b && (b.data("cke-saved-href") || b.getAttribute("href")) || "",
                    ...
                    e, g = {};
                a.match(t) && ("encode" == f ? a = a.replace(A, function(a, b, c) { c = c || "";
                    return "mailto:" + String.fromCharCode.apply(String, b.split(",")) + c.replace(/\\'/g, "'") }) : f && a.replace(B, function(a, b, c) {
                    if (b == d.name) {
                        g.type = "email";
                        a = g.email = {};
                        b = /(^')|('$)/g;
                    ...
                    case "email":
                        ...
                        switch (a) {
                            ...
                            case "encode":
                                ...
                                k && e.push("body\x3d" + k);
                                e = e.length ? "?" + e.join("\x26") : ""; "encode" == a ? (a = ["javascript:void(location.href\x3d'mailto:'+", q(f)], e && a.push("+'", p(e), "'"), a.push(")")) : a = ["mailto:", f, e];
                                break;
                            default:
    ...
    (function() {
        var f = { canUndo: !1, async: !0, exec: function(a, b) {
                var c = a.lang,
                ...
                g = function() {
                    ...
                    c.attachListener(c, "mousedown", function(b) {
                        ...
                        d && (d.wrapper = b.getAscendant(function(a) {
                            return a.hasAttribute("data-cke-widget-wrapper") }, !0))
                    }, this, null, -10)
                };
            a.on("contentDom", g);
            ...
            if (a.config.scayt_disableOptionsStorage) {
                ...
                a.config.scayt_disableOptionsStorage = function(a) {
                    for (var b = [], d = 0; d < a.length; d++) {
                        ...
                        if ("all" === c || n && g(a, "lang")) return []; "options" === c && (f = ["lang"]) }
    ...
    CKEDITOR.on("dialogDefinition", function(a) {
        ...
        if ("replace" === c) a.on("hide", function(a) { a = a.sender && a.sender.getParentEditor();
            var b = CKEDITOR.plugins.scayt,
                c = a.scayt;
    ...
    (function() {
        function q(d, e) {
            ...
            function c(b) { 0 < f.length || b.type != CKEDITOR.NODE_ELEMENT || !H.test(b.getName()) || b.getCustomData("selected_cell") || (CKEDITOR.dom.element.setMarker(a, b, "selected_cell", !0), f.push(b)) }
            var f = [],
                a = {};
            if (!d) return f;
            for (var h = d.getRanges(), k = 0; k < h.length; k++) {
                var g = h[k];
                if (g.collapsed)(g = g.getCommonAncestor().getAscendant({ td: 1, th: 1 }, !0)) && b(g) && f.push(g);
                else {
                    var g = new CKEDITOR.dom.walker(g),
                        l;
                    for (g.guard =
        ...
        function v(d) {
            if (d instanceof CKEDITOR.dom.selection) {
                ...
                a: {
                    ...
                    for (a = 0; k = b[a++];)
                        if ((g = k.getPrevious()) && !g.getCustomData("delete_cell") || (g = k.getNext()) && !g.getCustomData("delete_cell")) { CKEDITOR.dom.element.clearAllMarkers(h);
                            f = g;
                            break a }
        ...
        function z(d, e, b) {
            ...
            if (e) {
                ...
                try {
                    ...
                    n = h["up" == e ? l - C : "down" == e ? l + C : l]["left" == e ? r - a : "right" == e ? r + a : r] } catch (x) {
                    return !1 }
                if (!n || d.$ == n) return !1;
        ...
        function A(d, e) {
            ...
            if (1 < g) {
                l = Math.ceil(g / 2);
                for (var g = Math.floor(g / 2), c = h + l, f = new CKEDITOR.dom.element(f.$.rows[c]), a = y(a, c), r, c = b.clone(), h = 0; h < a.length; h++)
                ...
                for (g = l = 1, f = c.clone(), f.insertAfter(c), f.append(c = b.clone()), r = y(a, h), k = 0; k < r.length; k++) r[k].rowSpan++;
            c.appendBogus();
            b.$.rowSpan = l;
            c.$.rowSpan = g;
        ...
        CKEDITOR.plugins.tabletools = {
            ...
            init: function(d) {
                    ...
                    contentTransformations: [
                        [{
                            ...
                            right: function(a) { a.styles["background-color"] = f.background(a.styles.background).color }
                                ...
                                return a.attributes && a.attributes.valign }, right: function(a) { a.styles["vertical-align"] = a.attributes.valign;
                        ...
                        [{ element: "td", check: "td{height}", left: function(a) {
                                return (a = a.attributes) && a["cke-row-height"] }, right: function(a) { a.styles.height = a.attributes["cke-row-height"];
                ...
                b("rowInsertBefore", e({ requiredContent: "table", exec: function(a) { a = a.getSelection();
                        a = q(a);
                        t(a, !0) } }));
                b("rowInsertAfter", e({ requiredContent: "table", exec: function(a) { a = a.getSelection();
                        a = q(a);
                        t(a) } }));
                b("columnDelete", e({
                    requiredContent: "table",
                    exec: function(a) {
                        ...
                        for (m = n; m <= p; m++)
                            for (u = 0; u < f.length; u++) e = f[u], d = new CKEDITOR.dom.element(c.$.rows[u]),
                ...
                b("cellDelete", e({ requiredContent: "table", exec: function(a) { a = a.getSelection();
                        v(a) } }));
                ...
                b("cellMergeDown", e({
                    ...
                    exec: function(a,
                        b) { b.cell = z(a.getSelection(), "down");
                        x(b.cell, !0) }
                }));
    ...
    CKEDITOR.tools.buildTableMap = function(q, t, D, B, w) { q = q.$.rows;
        ...
        var p = -1,
            m = [];
        for (t = t || 0; t <= B; t++) { p++;!m[p] && (m[p] = []);
            for (var v = -1, x = D; x <= (-1 === w ? q[t].cells.length - 1 : w); x++) {
                var y = q[t].cells[x];
                if (!y) break;
                for (v++; m[p][v];) v++;
                for (var z = isNaN(y.colSpan) ? 1 : y.colSpan, y = isNaN(y.rowSpan) ? 1 : y.rowSpan, A = 0; A < y && !(t + A > B); A++) { m[p + A] || (m[p + A] = []);
    ...
    (function() {
        function x(a, b) {
            ...
            f > p && (c = f, f = p, p = c);
            for (c = k; c <= m; c++)
                for (k = f; k <= p; k++) d = new CKEDITOR.dom.element(e[c][k]), d.$ && !d.getCustomData("selected_cell") && (l.push(d), CKEDITOR.dom.element.setMarker(h,
                    d, "selected_cell", !0));
            CKEDITOR.dom.element.clearAllMarkers(h);
            return l
        }

        function z(a) { a = a.data.$;
        ...
        function N(a, b) {
            ...
            var d = a.getSelection(),
                ...
                p, r, C, g;
            k.getById("cke_table_copybin") || (p = k.createElement(f), r = k.createElement(f), r.setAttributes({ id: "cke_table_copybin", "data-cke-temp": "1" }), p.setStyles({ position: "absolute", width: "1px", height: "1px", overflow: "hidden" }), p.setStyle("ltr" == a.config.contentsLangDirection ?
                "left" : "right", "-5000px"), p.setHtml(a.getSelectedHtml(!0)), a.fire("lockSnapshot"), r.append(p), a.editable().append(r), g = a.on("selectionChange", c, null, null, 0), h && (C = l.scrollTop), m.selectNodeContents(p), m.select(), h && (l.scrollTop = C), setTimeout(function() { r.remove();
                d.selectBookmarks(e);
                g.removeListener();
                a.fire("unlockSnapshot");
        ...
        function A(a, b, c) { a.on("beforeCommandExec", function(d) {-1 !== CKEDITOR.tools.array.indexOf(b, d.data.name) && (d.data.selectedCells = u(a.getSelection())) });
        ...
        q.prototype.getTableMap = function() {
            ...
            a: { b = this.cells.last;
                ...
                for (e = 0; e < c[d].length; e++)
                    if ((new CKEDITOR.dom.element(c[d][e])).equals(b)) { b = e;
                        break a }
                b = void 0 }
        ...
        q.prototype.insertRow = function(a, b, c) {
            ...
            for (var d = this.cells.first.$.cellIndex, e = this.cells.last.$.cellIndex, k = c ? [] : this.cells.all, m, l = 0; l < a; l++) m = E(c ? this.cells.all : k, b), m = CKEDITOR.tools.array.filter(m.find("td, th").toArray(), function(a) {
                return c ? !0 : a.$.cellIndex >= d && a.$.cellIndex <= e }), k = b ? m.concat(k) : k.concat(m);
        ...
        q.prototype.emptyCells = function(a) { a = a || this.cells.all;
            for (var b = 0; b < a.length; b++) a[b].setHtml("") };
        q.prototype._arraySortByDOMOrder = function(a) { a.sort(function(a, c) {
        ...
        var G = {
            onPaste: function(a) {
                ...
                !k.length || 1 === k.length && !H(e.getRanges()[0]) && !l || l && !m || (k = k[0].getAscendant("table"), h = new q(u(e, k)), d.once("afterPaste", function() {
                    ...
                    t(d, a)
                }), m ? (a.stop(), l ? (h.insertRow(1, 1 === l, !0), e.selectElement(h.rows.first)) : (h.emptyCells(), t(d, h.cells.all)), a = h.getTableMap(), f = CKEDITOR.tools.buildTableMap(m), h.insertRow(f.length - a.length), h.insertColumn(b(f) - b(a)), a = h.getTableMap(), this.pasteTable(h, a, f), d.fire("saveSnapshot"), setTimeout(function() { d.fire("afterPaste") }, 0)) : (c(h.cells.first), d.once("afterPaste", function() { d.fire("lockSnapshot");
                    h.emptyCells(h.cells.all.slice(1));
                    t(d, h.cells.all);
                    d.fire("unlockSnapshot") })))
            },
            isBoundarySelection: function(a) { a = a.getRanges()[0];
            ...
            pasteTable: function(a, b, c) {
                var d, e = B(a.cells.first, !0),
                    k = a._getTable(),
                    m = {},
                    l, h, f, p;
                for (f = 0; f < c.length; f++)
                    for (l = new CKEDITOR.dom.element(k.$.rows[a.rows.first.$.rowIndex + f]), p = 0; p < c[f].length; p++)
                        if (h = new CKEDITOR.dom.element(c[f][p]), d = b[f] && b[f][p] ? new CKEDITOR.dom.element(b[f][p]) : null, h && !h.getCustomData("processed")) {
                            if (d && d.getParent()) h.replace(d);
                            else if (0 === p || c[f][p - 1])(d = 0 !== p ? new CKEDITOR.dom.element(c[f][p - 1]) : null) && l.equals(d.getParent()) ? h.insertAfter(d) : 0 < e ? l.$.cells[e] ? h.insertAfter(new CKEDITOR.dom.element(l.$.cells[e])) : l.append(h) :
                                l.append(h, !0);
        ...
        CKEDITOR.plugins.tableselection = {
            ...
            keyboardIntegration: function(a) {
                function b(a) { a.getEnclosedNode() ? a.getEnclosedNode().setText("") : a.deleteContents();
                ...
                c.attachListener(c, "keydown", function(a) {
                    function c(b, e) {
                        ...
                        CKEDITOR.tools.array.forEach(k, function(a) { a.enlarge(CKEDITOR.ENLARGE_ELEMENT) });
                        ...
                        if (g && g.is && g.is(m)) {
                            for (var q = g.getAscendant("table", !0), n = g.getPreviousSourceNode(!1, CKEDITOR.NODE_ELEMENT, q), t = !1, u = function(a) {
                                    return !g.contains(a) && a.is && a.is("td", "th") }; n && !u(n);) n = n.getPreviousSourceNode(!1, CKEDITOR.NODE_ELEMENT, q);
                    ...
                    return function(l) {
                        ...
                        if (k[h] && (f = a.getSelection()) && f.isInTable() && f.isFake)
                            if (g = f.getRanges(), n = g[0]._getTableElement(), q = g[g.length -
                                    1]._getTableElement(), l.data.preventDefault(), l.cancel(), 8 < h && 46 > h) g[0].moveToElementEditablePosition(m ? n : q, !m), f.selectRanges([g[0]]);
                            else {
